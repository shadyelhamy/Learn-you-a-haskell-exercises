...
-- Find the penultimate (avant dernier) element in list l
...
-- Determine if list l is a palindrome (qui se lit dans les deux sens)
...
-- Split a list l at element k+1 into a tuple: The first part up to and including k, the second part after k
